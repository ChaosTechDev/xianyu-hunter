...
class Task(BaseModel):
    ...
    collection_interval_minutes: int = 0
    retry_limit: int = 2
...
class TaskCreate(BaseModel):
    ...
    @field_validator("notify_price_below", mode="before")
    @classmethod
    def convert_notify_price(cls, value):
...
class TaskUpdate(BaseModel):
    ...
    runtime_status: Optional[Literal["stopped", "running", "paused", "scheduled", "cooldown", "failed"]] = None
