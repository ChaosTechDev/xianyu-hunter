...
const enUS = {
  ...
  results: {
    ...
    card: {
      ...
      fusedScore: 'Score',
      vetoed: 'Vetoed',
      sellerCredit: 'Seller trust',
      sellerCreditUnknown: 'Not enough seller data to score',
      sellerCreditRisk: 'Risk signals',
      vetoReason: 'Hard requirement failed: {items}',
      degraded: 'No price reference — score uses AI and keyword dimensions only',
    },
  },
  logs: {
    title: 'Logs',
